...
export async function getRolePermissions() {
    const resultado = await fetchWithAuth(`${URL_API}/api/RolePermissions`, {
        method: "GET"
    });
...
export async function getRolePermissionOData(query?: string) {
    ...
    const resultado = await fetchWithAuth(`${URL_API}/api/RolePermissions/getOData${queryString}`, {
        method: "GET"
    });
...
export async function deleteRolePermission(id: string) {
    ...
    const resultado = await fetchWithAuth(`${URL_API}/api/RolePermissions/${id}`, {
        method: "DELETE"
    });
