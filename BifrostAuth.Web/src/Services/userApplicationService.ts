...
export async function getUserApplications() {
    const resultado = await fetch(`${URL_API}/api/UserApplication`, {
        method: "GET",
...
export async function getUserApplicationOData(query?: string) {
    ...
    const resultado = await fetch(`${URL_API}/api/UserApplication/getOData${queryString}`, {
        method: "GET",
        headers: getAuthHeaders()
    });
...
export async function deleteUserApplication(id: string) {
    ...
    const resultado = await fetch(`${URL_API}/api/UserApplication/${id}`, {
        method: "DELETE",
        headers: getAuthHeaders()
    });
